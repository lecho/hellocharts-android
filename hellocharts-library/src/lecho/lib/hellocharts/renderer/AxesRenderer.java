...
public class AxesRenderer {
    ...
    protected void onChartDataOrSizeChanged() {
     ...
     */
    protected void initAxis(Axis axis, int position) {
        if (null == axis) {
            return;
        }
    ...
    protected void initAxisAttributes(Axis axis, int position) {
    ...
    protected void initAxisPaints(Axis axis, int position) {
    ...
    protected void initAxisTextAlignment(Axis axis, int position) {
    ...
    protected void initAxisDimensionForTiltedLabels(int position) {
    ...
    protected void initAxisDimension(int position) {
    ...
    protected void intiTiltedLabelsTranslation(Axis axis, int position) {
        int pythagoreanFromLabelWidth = (int) Math.sqrt(Math.pow(labelWidthTab[position], 2) / 2);
        int pythagoreanFromAscent = (int) Math.sqrt(Math.pow(labelTextAscentTab[position], 2) / 2);
        int dx = 0;
        int dy = 0;
    ...
    protected void initAxisMargin(Axis axis, int position) {
        int margin = 0;
    ...
    protected int getAxisNameMargin(Axis axis, int position) {
        int margin = 0;
    ...
    protected void insetContentRectWithAxesMargins(int axisMargin, int position) {
        if (LEFT == position) {
    ...
    protected void initAxisMeasurements(Axis axis, int position) {
        if (LEFT == position) {
            if (axis.isInside()) {
    ...
    protected void prepareAxisToDraw(Axis axis, int position) {
    ...
    protected void prepareCustomAxis(Axis axis, int position) {
    ...
    protected void prepareAutoGeneratedAxis(Axis axis, int position) {
        final Viewport visibleViewport = computator.getVisibleViewport();
        final Rect contentRect = computator.getContentRectMinusAllMargins();
        boolean isAxisVertical = isAxisVertical(position);
        float start, stop;
    ...
    protected boolean checkRawValue(Rect rect, float rawValue, boolean axisInside, int position, boolean isVertical) {
        if (axisInside) {
            if (isVertical) {
    ...
    protected void drawAxisLines(Canvas canvas, Axis axis, int position) {
    ...
    protected void drawAxisLabelsAndName(Canvas canvas, Axis axis, int position) {
        float labelX, labelY;
        labelX = labelY = 0;
        boolean isAxisVertical = isAxisVertical(position);
        if (LEFT == position || RIGHT == position) {
    ...
    protected boolean isAxisVertical(int position) {
        if (LEFT == position || RIGHT == position) {
            return true;
        } else if (TOP == position || BOTTOM == position) {
            return false;
