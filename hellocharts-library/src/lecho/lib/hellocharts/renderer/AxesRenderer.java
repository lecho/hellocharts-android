...
/**
 * Default axes renderer. For now there is only one implementation of axes renderer that why there is no interface for
 * it.
 */
public class AxesRenderer {
	...
	public void initAxesMeasurements() {
		...
		int axisYWidth = getAxisYWidth(chart.getChartData().getAxisY(), chart.getChartData().getMaxAxisLabelChars());
