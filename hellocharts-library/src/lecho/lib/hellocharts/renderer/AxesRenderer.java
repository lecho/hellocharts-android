...
public class AxesRenderer {
	...
	public void initRenderer() {
		mAxisLinePaint.setColor(mChart.getData().getAxesColor());
		mAxisTextPaint.setColor(mChart.getData().getAxesColor());
		mAxisTextPaint.setTextSize(Utils.sp2px(mContext, 14));
		mAxisTextPaint.getFontMetricsInt(fontMetrics);
	}

	public int getAxisXHeight() {
		final Axis axisX = mChart.getData().getAxisX();
		axesTextHeight = Math.abs(fontMetrics.top);
		int result = 0;
