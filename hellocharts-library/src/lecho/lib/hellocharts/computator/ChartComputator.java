...
public class ChartComputator {
	...
	public float computeRawX(float valueX) {
		// TODO: (contentRectMinusAllMargins.width() / currentViewport.width()) can be recalculated only when viewport change.
	 ...
	 * that pixel is within the chart region described by {@link #contentRectMinusAllMargins}. If the point is found, the "dest"
	 ...
	 * is simply the current size of {@link #contentRectMinusAllMargins}. If the chart is zoomed in 200% in both directions, the
