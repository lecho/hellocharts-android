...
public class PathCompat {
	...
	// int valueIndex = 0;
	// for (LinePoint animatedPoint : line.animatedPoints) {
	...
	// }
	//
	// public void drawCubicPath(final Canvas canvas, ChartCalculator chartCalculator, final Line line, final Paint
	// paint) {
	// int step = 6;
	...
	// LinePoint animatedPoint = line.animatedPoints.get(valueIndex);
	...
	// if (valueIndex > 0) {
	// LinePoint animatedPoint = line.animatedPoints.get(valueIndex - 1);
	...
	// LinePoint animatedPoint = line.animatedPoints.get(valueIndex + 2);
